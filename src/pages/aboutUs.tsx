    ...
    <>
      ...
      >
        ...
        >
          ...
          מכיל מגוון עצום של תכנים קולינריים, תכניות בישול ומתכונים . המיזם
          תוכנן ונבנה בהתאם לצרכים הקולינריים של הקהל הישראלי ומאחוריו עומדת
          שורה של אנשי קולינריה מהמשפיעים בישראל, ביניהם: שפים, בלוגרים,
          מתכונאים, מפיקים, יועצי מטבח, יועצים קולינאריים, צלמים ועוד.
        </Typography>
      </Box>
    </>
  );
